        ...
        <div className="bg-white rounded-3xl shadow-xl border border-slate-200 overflow-hidden">
          <div className="bg-gradient-to-r from-slate-900 via-slate-800 to-amber-700 px-8 py-10 text-white">
            ...
            <p className="mt-4 max-w-2xl text-base text-white/85">
              This page explains how La Bodeguita collects customer consent to receive
              SMS messages related to promotions, new products, and store updates.
            </p>
          </div>
          ...
          <div className="px-8 py-8 space-y-8 text-slate-700">
            ...
            <section className="space-y-3">
              ...
              <p>
                ...
                to any message received from La Bodeguita.
              </p>
              <p>
            ...
            <section className="space-y-3">
              ...
              <p>
                ...
                La Bodeguita and is not sold or shared with third parties for unrelated
                marketing purposes.
              </p>
            </section>
            ...
            <section className="rounded-2xl border border-amber-200 bg-amber-50 px-5 py-4">
              ...
              <div className="mt-2 space-y-2 text-slate-800">
                <p>
                  By providing your phone number, you agree to receive recurring SMS messages from
                  La Bodeguita related to promotions, new products, and store updates.
                </p>
